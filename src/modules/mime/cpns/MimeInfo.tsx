...
import { LayoutChangeEvent, TouchableOpacity, View, Text, Image, StyleSheet } from 'react-native';
...
type Props = {
  userInfo: any;
  info: any;
  setBgImgHeight: (f: number) => void;
};

function MimeInfo({ userInfo, info, setBgImgHeight }: Props) {
